    ...
    <div className="flex min-h-screen w-full bg-background font-sans selection:bg-primary/30">
      ...
      <div className="hidden lg:flex w-[45%] flex-col justify-between p-12 bg-card/30 border-r border-border/50 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground mb-12">Create an account to start analyzing and organizing your visual assets.</p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 relative">
        ...
        >
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 text-white font-medium text-base shadow-lg shadow-primary/20 transition-all mt-4 active:scale-[0.98]"
              disabled={isLoading || isGoogleLoading || !email || !password || !name}
            >
          ...
          <p className="text-center text-xs text-muted-foreground mt-8">
            By signing up you agree to our <Link href="/terms" className="underline hover:text-foreground">Terms</Link> & <Link href="/privacy" className="underline hover:text-foreground">Privacy Policy</Link>.
          </p>
        </motion.div>
      </div>
    </div>
